...
class GymsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gym" do
    assert_difference('Gym.count') do
      post gyms_url, params: { gym: { city_id: @gym.city_id, leader_id: @gym.leader_id, medal_thumb: @gym.medal_thumb, name: @gym.name } }
    end
  ...
  test "should update gym" do
    patch gym_url(@gym), params: { gym: { city_id: @gym.city_id, leader_id: @gym.leader_id, medal_thumb: @gym.medal_thumb, name: @gym.name } }
